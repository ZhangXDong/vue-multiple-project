<template>
    <div class="ld-sunwodaMaterialCarry_unloadPoint">
        <!-- 操作顶升 -->
...
export default {
    ...
    methods: {
        ...mapMutations({
            ...
            saveRPMData: 'SUNWODA_SAVE_RPMDATA' // 保存rpm数据
        }),
        init() {
            let RPMData = this.sunwodaGetRPMData
            if (!RPMData) { 
...
<style lang="scss">
.ld-sunwodaMaterialCarry_unloadPoint {
    height: 100%;
    display: flex;
