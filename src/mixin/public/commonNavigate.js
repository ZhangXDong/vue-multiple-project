...
const commonNavigateMixin = {
    ...
    methods: {
        ...
        commonNavigate(information) {
            ...
            if (information.robotBaseStatus === 1) {
                ...
                if (information.robotLogicStatus === 3) { 
                    ...
                    this.saveScheduleCurrentOrder({
                        ...
                        stationName: this.stationInfo.externalStationName || this.stationInfo.stationName || this.gatherOrder.orderSetList[0].orderList[this.stationInfo.index].stationName,
                        isNavigate: 2
                    })
                    this.saveFooterBtns([{
                        title: '暂停',
                ...
                if (information.robotLogicStatus === 13) { 
                    ...
                    this.saveScheduleCurrentOrder({
                        ...
                        workingCondition: '正在前往',
                        taskNumber: this.gatherOrder && this.gatherOrder.orderSetList[0].name,
                        stationName: this.stationInfo.externalStationName || this.stationInfo.stationName || '电梯排队点',
                        isNavigate: -1
                    })
                    this.saveFooterBtns([{
                        title: '暂停',
                ...
                if (information.robotLogicStatus === 15) {
                    ...
                    this.saveScheduleCurrentOrder({
                        ...
                        workingCondition: '正在前往',
                        taskNumber: this.gatherOrder && this.gatherOrder.orderSetList[0].name,
                        stationName: this.stationInfo.externalStationName || this.stationInfo.stationName || '尾料回收点',
                        isNavigate: -1
                    })
                    this.saveFooterBtns([{
                        title: '暂停',
            ...
            if (this.$route.path !== '/commonNavigate') {
                this.$router.replace({ path: '/commonNavigate' })
            }
        }
    }
}
export default commonNavigateMixin